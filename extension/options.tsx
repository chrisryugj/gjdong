      ...
      <div className="max-w-lg mx-auto p-6 space-y-5">
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
          ...
          <div className="pt-1 border-t border-gray-100">
            ...
            <p className="text-[11px] text-gray-400 mb-1.5">클립보드 감지·우클릭을 '팝업으로 열기'로 쓸 때 적용</p>
            <div className="flex gap-2">
              {([
                { value: "reuse", label: "기존 창에서 갱신", desc: "한 창에서 연속 조회 (복붙 多)" },
                { value: "new", label: "계속 새 창", desc: "결과를 창마다 따로 보관" }
              ] as const).map(opt => (
                <button
                  key={opt.value}
