              ...
              {cards.map((f, i) => {
                ...
                return (
                  <button
                    ...
                    className={`dump-rise rounded-lg border p-3 text-left transition-all hover:border-(--dump-accent)/60 ${
                      active
                        ? "border-(--dump-accent) bg-(--dump-accent)/10  ring-2 ring-(--dump-accent)/30"
                        : f.accent
                          ? "border-(--dump-accent)/50 bg-(--dump-accent)/5"
                  ...
                  >
                    <span className="mb-1.5 flex flex-wrap items-center gap-1.5">
                      ...
                      {active && (
                        <span className="rounded bg-(--dump-accent) px-1.5 py-0.5 text-[12.5px] font-semibold text-white">✓ 지도 반영 중</span>
                      )}
                    </span>
                    ...
                    <span className="mt-1.5 inline-block text-[13.5px] font-medium text-(--dump-accent)">자세히 보기 →</span>
                  </button>
                )
              })}
            </div>
            ...
            <div className="mb-2 flex items-baseline justify-between gap-2">
              ...
              <div className="flex items-center gap-2.5">
                <button
                  ...
                  className="rounded-md bg-(--dump-accent) px-2 py-0.5 text-[14.5px] font-medium text-white"
                >
                  동 브리핑 인쇄
                </button>
                <button
      ...
      {data && graph && (
        <details className="rounded-lg border border-[var(--cp-border)] bg-[var(--cp-panel)] px-3 py-2">
          <summary className="flex cursor-pointer list-none items-baseline gap-2.5 text-[18px] font-bold text-[var(--cp-text-strong)] [&::-webkit-details-marker]:hidden">
            ...
            <span className="text-[13px] font-medium text-(--dump-accent)">펼치기</span>
          </summary>
          <div className="mt-2">
