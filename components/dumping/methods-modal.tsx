...
const METHODS: Method[] = [
  ...
  },
  {
    ...
    here: "격자 1,062칸에서 과태료 건수를 종속변수로 놓고 분석해 보니, 관리주체 없는 주거 밀도가 β +0.312로 가장 컸고 공동주택 세대수는 무효(p=0.708), 골목 비율은 오히려 음수(−0.222)였습니다.",
  ...
  {
    name: "핫스팟 점수와 백테스트",
    easy: "최근에 생긴 일일수록 가중치를 높여(90일이 지나면 절반) 격자마다 점수를 매기고, 점수가 높은 지역을 다음 분기 관리 대상으로 뽑습니다. 믿을 만한지는 과거 시점으로 돌아가 확인합니다. 작년 이맘때 이 방법으로 뽑았다면 실제로 맞았을지를 8개 분기에 걸쳐 반복 채점했습니다.",
  ...
  },
  {
    ...
    here: "직전 8개월을 한 달씩 제외하고 예측해 보는 검증에서 평균 오차가 18%였습니다. 인력과 순찰 배치를 위한 행정수요 전망으로만 씁니다.",
  ...
  },
  {
    ...
    here: "69개 지식과 95개 연결로 구성했습니다. 청년·외국인·1인세대 요인에 대응 수단이 없다는 빈칸이 여기서 드러나, 다국어 안내와 전입 시점 안내 등 신규 대책 세 가지가 나왔습니다.",
  },
  {
    name: "검증 하네스와 한계 공개",
