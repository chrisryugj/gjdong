...
const STAT_HELP: [string, string][] = [
  ["β(베타)", "0보다 크면 이 요인이 많은 곳일수록 무단투기도 많다는 뜻. 음수면 반대."],
  ["p값", "이런 결과가 우연으로 나올 확률. 0.05보다 작으면 우연이라 보기 어렵다."],
  ["DID", "조치한 곳과 안 한 곳의 전후 변화 차이. 0이면 효과가 없다는 뜻."],
  ["상관 ρ", "두 값이 같이 움직이는 정도. 1에 가까울수록 거의 붙어 다닌다."],
]
