...
// /dumping 스키마와 같은 형식이지만 도메인이 다르다: 제설 대응자원(Lever)이 취약요인(Concept)을 겨냥하고 행정동(Area)을 덮으며,
...
export const CLASSES: ClassDef[] = [
  ...
  { type: "Concept", space: "concept", en: "Vulnerability factor", def: "결빙·적설 피해가 커지는 조건(급경사·통학로·이면도로·야간 결빙 등). 자원이 겨냥하는 대상" },
  { type: "Claim", space: "claim", en: "Claim", def: "관측이 뒷받침하는 판단. 들어오는 supports 엣지가 없으면 스키마 위반" },
  { type: "KPI", space: "outcome", en: "Indicator", def: "대응이 겨냥하는 결과 지표. measurable 속성이 '데이터 없음'이면 지금은 잴 수 없다" },
...
export const RELATIONS: RelDef[] = [
  ...
  { rel: "targets", en: "targets", kind: "targeting", def: "대응자원이 겨냥하는 취약요인. 효과를 단언하지 않는다", domain: ["Lever"], range: ["Concept"] },
  ...
  { rel: "operationalizes", en: "operationalizes", kind: "targeting", def: "잴 수 있는 지표가 잴 수 없는 상위 지표를 대신한다", domain: ["KPI"], range: ["KPI"] },
  { rel: "covers", en: "covers", kind: "coverage", def: "대응자원이 행정동에 몇 개소 있는가(count·length_m·bags)", domain: ["Lever"], range: ["Area"] },
  ...
  { rel: "governs", en: "governs", kind: "governance", def: "판단이 지표·자원의 해석 규칙을 정한다(예: 잴 데이터가 없다)", domain: ["Claim"], range: ["KPI", "Lever"] },
]
