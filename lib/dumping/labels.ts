...
export const PROP_HELP: Record<string, string> = {
  ...
  p_value: "p값: 연관이 없다고 가정했을 때 이만한 차이가 나올 가능성입니다. 0.05보다 작으면 이 분석에서 연관이 확인된 것으로 봅니다. 원인을 뜻하지는 않습니다.",
  p: "p값: 연관이 없다고 가정했을 때 이만한 차이가 나올 가능성입니다. 0.05보다 작으면 이 분석에서 연관이 확인된 것으로 봅니다. 원인을 뜻하지는 않습니다.",
